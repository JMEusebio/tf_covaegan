...
parser.add_argument('--L1_lambda', dest='L1_lambda', type=float, default=3, help='weight on L1 term in objective')
...
parser.add_argument('--target_name', dest='target_name', default='mnist', help='mnist, svhn')
parser.add_argument('--source_name', dest='source_name', default='SVHN', help='mnist, svhn')
parser.add_argument('--rep_size', dest='rep_size', type=int, default=1024, help='scale images to this size')
parser.add_argument('--debug', dest='debug', type=bool, default=False, help='debugging')
